...
/**
 * Batch runner for 5th test of UML diagram.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class UmlDiagramTest05BatchRunner extends UmlDiagramTestBatchRunner {
  ...
  public static void main(String[] args) {
    ...
    UmlDiagramTestBatchRunner runner = new UmlDiagramTest05BatchRunner();
    runner.run();
  }
