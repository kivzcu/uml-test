...
/**
 * Batch runner for 8th test of UML diagram.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class UmlDiagramTest08BatchRunner extends UmlDiagramTestBatchRunner {
  ...
  public static void main(String[] args) {
    ...
    UmlDiagramTestBatchRunner runner = new UmlDiagramTest08BatchRunner();
    runner.run();
  }
