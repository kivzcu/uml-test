...
/**
 * Test of integer list property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class IntegerPropertyKeyListTest extends PropertyKeyTestAncestor {
  ...
  public static final IntegerPropertyKey.List PROPERTY_KEY_LIST = new IntegerPropertyKey.List("integer.property.list", "|");
  ...
  public void testUnsetValueOfListPropertyKey() {
    assertCollectionsEquals(new ArrayList<Integer>(), PROPERTY_KEY_LIST.getListValue(emptyProperties));
  }
  ...
  public void testEmptyValueOfPropertyKey() {
    assertCollectionsEquals(new ArrayList<Integer>(), PROPERTY_KEY_LIST.getListValue(propertiesWithEmptyValues));
  }
  ...
  public void testCorrectValueOfPropertyKey() {
    Integer[] correctValues = new Integer[] {1, 256, -512};
