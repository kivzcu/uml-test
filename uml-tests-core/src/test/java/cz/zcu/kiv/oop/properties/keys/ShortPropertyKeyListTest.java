...
/**
 * Test of short list property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class ShortPropertyKeyListTest extends PropertyKeyTestAncestor {
  ...
  public static final ShortPropertyKey.List PROPERTY_KEY_LIST = new ShortPropertyKey.List("short.property.list", "|");
  ...
  public void testUnsetValueOfListPropertyKey() {
    assertCollectionsEquals(new ArrayList<Short>(), PROPERTY_KEY_LIST.getListValue(emptyProperties));
  }
  ...
  public void testEmptyValueOfPropertyKey() {
    assertCollectionsEquals(new ArrayList<Short>(), PROPERTY_KEY_LIST.getListValue(propertiesWithEmptyValues));
  }
  ...
  public void testCorrectValueOfPropertyKey() {
    Short[] correctValues = new Short[] {10, -20, 15};
