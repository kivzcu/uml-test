...
/**
 * Test of boolean list property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class BooleanPropertyKeyListTest extends PropertyKeyTestAncestor {
  ...
  public static final BooleanPropertyKey.List PROPERTY_KEY_LIST = new BooleanPropertyKey.List("boolean.property.list", "|");
  ...
  public void testUnsetValueOfListPropertyKey() {
    assertCollectionsEquals(new ArrayList<Boolean>(), PROPERTY_KEY_LIST.getListValue(emptyProperties));
  }
  ...
  public void testEmptyValueOfPropertyKey() {
    assertCollectionsEquals(new ArrayList<Boolean>(), PROPERTY_KEY_LIST.getListValue(propertiesWithEmptyValues));
  }
  ...
  public void testCorrectValueOfPropertyKey() {
    Boolean[] correctValues = new Boolean[] {Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE};
  ...
  public void testWrongValueOfPropertyKey() {
    Boolean[] wrongValues = new Boolean[6];
    Arrays.fill(wrongValues, Boolean.FALSE);
