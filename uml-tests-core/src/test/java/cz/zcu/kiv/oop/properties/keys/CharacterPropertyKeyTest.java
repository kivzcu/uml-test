...
/**
 * Test of character property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
@RunWith(Parameterized.class)
public class CharacterPropertyKeyTest extends PropertyKeyTestAncestor {
  ...
  public static Collection<Object[]> getParameters() {
    ...
    parameters.add(new Object[] {new CharacterPropertyKey("character.property.1", 'c'), 'c'});
    parameters.add(new Object[] {new CharacterPropertyKey("character.property.2", ' '), ' '});
    parameters.add(new Object[] {new CharacterPropertyKey("character.property.3", 'A'), 'A'});
  ...
  @Parameter(0)
  public PropertyKey<Character> propertyKey;

  @Parameter(1)
  public Character correctValue;
