...
/**
 * Test of float list property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class FloatPropertyKeyListTest extends PropertyKeyTestAncestor {
  ...
  public static final FloatPropertyKey.List PROPERTY_KEY_LIST = new FloatPropertyKey.List("float.property.list", "|");
  ...
  public void testUnsetValueOfListPropertyKey() {
    assertCollectionsEquals(new ArrayList<Float>(), PROPERTY_KEY_LIST.getListValue(emptyProperties));
  }
  ...
  public void testEmptyValueOfPropertyKey() {
    assertCollectionsEquals(new ArrayList<Float>(), PROPERTY_KEY_LIST.getListValue(propertiesWithEmptyValues));
  }
  ...
  public void testCorrectValueOfPropertyKey() {
    Float[] correctValues = new Float[] {21.0f, 22.0f, 23.0f};
