...
/**
 * Test of string property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class StringPropertyKeyTest extends PropertyKeyTestAncestor {
  ...
  public static final String CORRECT_VALUE = "Hello World!";
  public static final String INVALID_VALUE = "string";
  public static final StringPropertyKey PROPERTY_KEY = new StringPropertyKey("string.property", CORRECT_VALUE);
  ...
  public void testWrongValueOfPropertyKey() {
    Assert.assertEquals(INVALID_VALUE, PROPERTY_KEY.getValue(propertiesWithWrongValues));
  }
  ...
  public void testWrongPropertyKeyWithDefaultValueOnParseError() {
    Assert.assertEquals(INVALID_VALUE, PROPERTY_KEY.getValue(propertiesWithWrongValues, true));
  }
