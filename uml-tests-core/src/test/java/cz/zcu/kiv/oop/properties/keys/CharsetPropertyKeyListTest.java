...
/**
 * Test of character set list property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class CharsetPropertyKeyListTest extends PropertyKeyTestAncestor {
  ...
  public static final CharsetPropertyKey.List PROPERTY_KEY_LIST = new CharsetPropertyKey.List("charset.property.list", "|");
  ...
  public void testUnsetValueOfListPropertyKey() {
    assertCollectionsEquals(new ArrayList<Charset>(), PROPERTY_KEY_LIST.getListValue(emptyProperties));
  }
  ...
  public void testEmptyValueOfPropertyKey() {
    assertCollectionsEquals(new ArrayList<Charset>(), PROPERTY_KEY_LIST.getListValue(propertiesWithEmptyValues));
  }
  ...
  public void testCorrectValueOfPropertyKey() {
    Charset[] correctValues = new Charset[] {Charset.forName("utf-8"), Charset.forName("utf-16")};
