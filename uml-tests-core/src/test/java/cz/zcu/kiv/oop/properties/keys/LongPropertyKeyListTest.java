...
/**
 * Test of long list property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class LongPropertyKeyListTest extends PropertyKeyTestAncestor {
  ...
  public static final LongPropertyKey.List PROPERTY_KEY_LIST = new LongPropertyKey.List("long.property.list", "|");
  ...
  public void testUnsetValueOfListPropertyKey() {
    assertCollectionsEquals(new ArrayList<Long>(), PROPERTY_KEY_LIST.getListValue(emptyProperties));
  }
  ...
  public void testEmptyValueOfPropertyKey() {
    assertCollectionsEquals(new ArrayList<Long>(), PROPERTY_KEY_LIST.getListValue(propertiesWithEmptyValues));
  }
  ...
  public void testCorrectValueOfPropertyKey() {
    Long[] correctValues = new Long[] {1001L, -2056L, 150L};
