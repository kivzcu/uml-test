...
/**
 * Test of character set property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class CharsetPropertyKeyTest extends PropertyKeyTestAncestor {
  ...
  public static final Charset CORRECT_VALUE = Charset.forName("utf-8");
  public static final CharsetPropertyKey PROPERTY_KEY = new CharsetPropertyKey("charset.property", CORRECT_VALUE);
