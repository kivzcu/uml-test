...
/**
 * Test of character list property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class CharacterPropertyKeyListTest extends PropertyKeyTestAncestor {
  ...
  public static final CharacterPropertyKey.List PROPERTY_KEY_LIST = new CharacterPropertyKey.List("character.property.list", "|");
  ...
  public void testUnsetValueOfListPropertyKey() {
    assertCollectionsEquals(new ArrayList<Character>(), PROPERTY_KEY_LIST.getListValue(emptyProperties));
  }
  ...
  public void testEmptyValueOfPropertyKey() {
    assertCollectionsEquals(new ArrayList<Character>(), PROPERTY_KEY_LIST.getListValue(propertiesWithEmptyValues));
  }
  ...
  public void testCorrectValueOfPropertyKey() {
    Character[] correctValues = new Character[] {'c', ' ', 'A'};
