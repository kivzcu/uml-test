...
import cz.zcu.kiv.oop.properties.keys.EnumPropertyKeyListTest.MockEnum;
...
/**
 * Test of enumeration property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class EnumPropertyKeyTest extends PropertyKeyTestAncestor {
  ...
  public static final MockEnum CORRECT_VALUE = MockEnum.THREE;
  public static final EnumPropertyKey<MockEnum> PROPERTY_KEY = new EnumPropertyKey<MockEnum>("enum.property", MockEnum.class, CORRECT_VALUE);
