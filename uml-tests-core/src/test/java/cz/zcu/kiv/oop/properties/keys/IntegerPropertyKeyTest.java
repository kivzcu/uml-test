...
/**
 * Test of integer property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class IntegerPropertyKeyTest extends PropertyKeyTestAncestor {
  ...
  public static final Integer CORRECT_VALUE = 101;
  public static final IntegerPropertyKey PROPERTY_KEY = new IntegerPropertyKey("integer.property", CORRECT_VALUE);
