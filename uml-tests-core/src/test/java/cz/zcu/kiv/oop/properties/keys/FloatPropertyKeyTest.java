...
/**
 * Test of float property key.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
@RunWith(Parameterized.class)
public class FloatPropertyKeyTest extends PropertyKeyTestAncestor {
  ...
  public static Collection<Object[]> getParameters() {
    ...
    parameters.add(new Object[] {new FloatPropertyKey("float.property.1", 21.0f), 21.0f});
    parameters.add(new Object[] {new FloatPropertyKey("float.property.2", 22.0f), 22.0f});
    parameters.add(new Object[] {new FloatPropertyKey("float.property.3", 23.0f), 23.0f});
  ...
  @Parameter(0)
  public PropertyKey<Float> propertyKey;
