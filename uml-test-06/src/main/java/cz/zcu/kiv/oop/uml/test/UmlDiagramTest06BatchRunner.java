...
/**
 * Batch runner for 6th test of UML diagram.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class UmlDiagramTest06BatchRunner extends UmlDiagramTestBatchRunner {
  ...
  public static void main(String[] args) {
    ...
    UmlDiagramTestBatchRunner runner = new UmlDiagramTest06BatchRunner();
    runner.run();
  }
