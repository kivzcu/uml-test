...
/**
 * Batch runner for 7th test of UML diagram.
 *
 * @author Mr.FrAnTA (Michal Dékány)
 */
public class UmlDiagramTest07BatchRunner extends UmlDiagramTestBatchRunner {
  ...
  public static void main(String[] args) {
    ...
    UmlDiagramTestBatchRunner runner = new UmlDiagramTest07BatchRunner();
    runner.run();
  }
